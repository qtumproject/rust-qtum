...
fn bitcoin_genesis_tx() -> Transaction {
    ...
    let in_script = script::Builder::new()
        .push_opcode(crate::opcodes::OP_0)
        .push_int(488804799)
...
impl ChainHash {
    ...
    pub const QTUM: Self = Self([
        108, 152, 237, 130, 85, 94, 249, 227, 214, 52, 131, 217, 33,
    ...
    pub const TESTNET: Self = Self([
        34, 66, 225, 245, 81, 186, 178, 254, 102, 173, 42, 151, 23,
    ...
    pub const SIGNET: Self = Self([
        71, 19, 100, 144, 196, 211, 12, 198, 157, 213, 98, 98, 64, 95,
    ...
    pub const REGTEST: Self = Self([
        67, 233, 218, 250, 46, 151, 251, 88, 154, 238, 183, 120, 114,
...
mod test {
    ...
    fn bitcoin_genesis_first_transaction() {
        ...
        assert_eq!(
            gen.wtxid().to_string(),
            "ed34050eb5909ee535fcb07af292ea55f3d2f291187617b44d3282231405b96d"
        );
    }
    ...
    fn signet_genesis_full_block() {
        ...
        assert_eq!(
            gen.header.block_hash().to_string(),
            "0000e0d4bc95abd1c0fcef0abb2795b6e8525f406262d59dc60cd3c490641347"
        );
    }
